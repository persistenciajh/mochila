...
import com.mochila.framework.dao.IDao;
import com.mochila.framework.util.ConfiguradorIbatis;
...
public abstract class DaoStandard implements IDao {
	...
	/**
	 * Se escribe aquï¿½ lo que deberï¿½a inicializar todos los daos decendientes de esta clase
	 */
	public DaoStandard() {
		super();
	}
